...
public class Visualizer extends JFrame
{
    ...
    /**
     * The set of points to be classified. The data is represented as red points on
     * the scatter plot
     */
    ...
    /**
     * Constructor. Calls assembleData method to collect the data together, creates
     * a scatter plot, and displays the graph in the JFrame.
     * 
     * @param trainingData
     ...
     */
    public Visualizer(double[][] trainingData, double[] weightVector, int currentEpoch)
    {
        ...
        // assembleData method
        JFreeChart graph = ChartFactory.createScatterPlot("Classification After " + currentEpoch + " Epochs", "X", "Y",
                data);
    ...
    /**
     * Assembles the training set and the classification points determined by the
     * weight vector into a JFreeChart collection. Two XYSeries contain the training
     * set and classification points, which are then added to the XYSeriesCollection
     * to be display in the constructor.
     * 
     * @return XYDataset Collection of data points in the training set and the two
     *         classifier points determined by the weight vectors.
     */
    public XYDataset assembleData()
    {
        ...
        // Add points corresponding to the appropriate weight vector values to present
